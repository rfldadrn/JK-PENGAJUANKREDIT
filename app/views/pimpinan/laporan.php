            ...
            <form method="GET" action="" id="filterForm">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?= BASE_URL ?>pimpinan/laporan" class="btn btn-secondary">
...
function exportPdf() {
    ...
    window.open('<?= BASE_URL ?>pimpinan/exportPdf?' + params, '_blank');
}

function exportExcel() {
    const form = document.getElementById('filterForm');
    const params = new URLSearchParams(new FormData(form)).toString();
    window.location.href = '<?= BASE_URL ?>pimpinan/exportExcel?' + params;
}
</script>
