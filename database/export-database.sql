...
-- Dumping data for table db_pengajuan_kredit.tb_analisis_kredit: ~0 rows (approximately)
...
-- Dumping data for table db_pengajuan_kredit.tb_dokumen: ~0 rows (approximately)
...
-- Dumping data for table db_pengajuan_kredit.tb_nasabah: ~1 rows (approximately)
...
-- Dumping data for table db_pengajuan_kredit.tb_notifikasi: ~2 rows (approximately)
...
-- Dumping data for table db_pengajuan_kredit.tb_pengajuan_kredit: ~0 rows (approximately)
...
-- Dumping data for table db_pengajuan_kredit.tb_users: ~6 rows (approximately)
REPLACE INTO `tb_users` (`id_user`, `nama_lengkap`, `email`, `password`, `no_hp`, `role`, `status_akun`, `foto_profil`, `token_reset`, `created_at`, `updated_at`) VALUES
	(1, 'Administrator', 'admin@bri.co.id', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '081234567890', 'admin', 'aktif', NULL, NULL, '2026-04-07 19:45:48', '2026-04-07 20:14:50'),
	...
	(4, 'Pimpinan Cabang', 'pimpinan@bri.co.id', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '081234567893', 'pimpinan', 'aktif', NULL, NULL, '2026-04-07 19:45:48', '2026-04-07 20:59:56'),
	(5, 'Rifaldi Adrian', 'rifaldiadrian25@gmail.com', '$2y$10$bIJhli8CVwL9EHR4Vb5hwuNMhbgK2t8muly/ziQV5dN5m3qHbKwha', '081270892182', 'admin', 'aktif', NULL, NULL, '2026-04-07 20:00:09', '2026-04-07 20:00:09'),
	(6, 'Rifaldi Adrian', 'rifaldiadrian28@gmail.com', '$2y$10$qdRzBH5x3SC0QZVWvWsDK.qy7th3nSoOjp7EkqLPjLRXrU5ixA9e2', '081270892182', 'nasabah', 'aktif', NULL, NULL, '2026-04-07 20:09:25', '2026-04-07 20:09:32');
...
-- Dumping data for table db_pengajuan_kredit.tb_verifikasi: ~0 rows (approximately)
